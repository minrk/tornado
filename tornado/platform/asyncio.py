...
class AddThreadSelectorEventLoop(asyncio.AbstractEventLoop):
    ...
    def __init__(self, real_loop: asyncio.AbstractEventLoop) -> None:
        ...
        self._reader_fut = {}  # type: Dict[Tuple[_FileDescriptorLike, int], Optional[concurrent.futures.Future]]
        self._writer_fut = {}  # type: Dict[Tuple[_FileDescriptorLike, int], Optional[concurrent.futures.Future]]
